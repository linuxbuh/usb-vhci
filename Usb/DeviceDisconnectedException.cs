/*
 * DeviceDisconnectedException.cs -- USB related classes
 *
...
{
	[Serializable]
	public class DeviceDisconnectedException : IOException
	{
		public DeviceDisconnectedException() :
			base("The device was disconnected.")
		{
		}
		...
		protected DeviceDisconnectedException(SerializationInfo info,
